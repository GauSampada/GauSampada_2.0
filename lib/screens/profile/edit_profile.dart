...
class EditProfileScreen extends StatelessWidget {
  ...
  Widget buildProfileForm(BuildContext context, UserProvider provider) {
    ...
    final locationController =
        TextEditingController(text: provider.user.location);
              ...
              : CustomElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    if (res == 'update') {
                      ...
                      toastMessage(
                          context: context,
                          message: 'Retry again, profile not updated',
                          position: DelightSnackbarPosition.top);
                    }
                  },
                ),
